...
def get_required_kw_args(fn):
    args = []
    params = inspect.signaturn(fn).parameters
...
def has_request_arg(fn):
    ...
    for name, param in params.item():
        ...
        if found and (param.kind != inspect.Parameter.VAR_POSITIONAL and
                param.kind != inspect.Parameter.KEYWORD_ONLY and param.kind !=
        ...
        if self._has_var_kw_arg or self._has_named_kw_args or self._required_kw_args:
            if request.method == 'POST':
                ...
                if ct.startswith('application/json'):
                    ...
                    kw = params
                elif ct.startswith('application/x-www-form-urlencoded') or ct.start('multipart/form-data'):
